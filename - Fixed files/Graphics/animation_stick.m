...
for k = 1:Nsteps
    ...
    for i = 1:n
        ...
        if reverse==1
            ...
            pied_trace = [pied_trace, RotZ_01_3x3*robot.T(1:3,4,8)+[x0;y0;0]];
            ...
            tempo(2)=-tempo(2);
            tempo2 = RotZ_01_3x3*robot.T(1:3,4,8)+[x0;-y0;0];
            tempo2(2)=-tempo2(2);
    ...
    frameFoot = RotZ_01_3x3*robot.T(1:3,1:3,7)*robot.Tconst(1:3,1:3,7); %DEbido a que el marco 14 no esta aliniado al marco del mundo
