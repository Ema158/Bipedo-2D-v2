...
pos(1,17) = -deg2rad(119.5);%-120
pos(2,17) =  deg2rad(119.5);%120

vel(13) =8.26797;
vel(17) =8.26797;

tor(18) =19.0949993134;

%Shoulder yaw
pos(1,14) = -deg2rad(76);%-95
pos(2,14) = deg2rad(18);%0

pos(1,18) =  -deg2rad(18);%0
pos(2,18) =  deg2rad(76);%95

vel(14) =7.19407;
vel(18) =7.19407;

tor(19) =9.03100013733;
...
tor(21) =2.17700004578;


% Head pitch
pos(1,22) = -deg2rad(38.5);%-45
pos(2,22) = deg2rad(29.5);%45
