function   Biped_param = SS_bipedo_StoppingDS()
...
ZMPxIni =  0.001769957857284;      % Local position of the desired ZMP in X for each step
ZMPxMid = 0.001;
ZMPxEnd =  0;
Pos = [T1 ZMPxIni;
%        T/2 ZMPxMid;
...
gait_parameters.ZMPxMid = ZMPxMid;   % Initial desired position in X
